(function ($) {
    $.fn.jquizzy = function (settings) {
        ...
        superContainer.find('.final').click(function () {
            ...
            shareButton = '<a href="http://twitter.com/share?text=' + config.twitterStatus.replace("{score}", score) + '&via=' + config.twitterUsername + '" class="share-button"><img src="' + config.twitterImage + '" /></a>';
